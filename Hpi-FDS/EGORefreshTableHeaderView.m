...
- (void)setState:(EGOPullRefreshState)aState{
	...
	switch (aState) {
		case EGOOPullRefreshPulling:
			//NSLog(@"wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww EGOOPullRefreshPulling =[%@]",@"up");
		...
		case EGOOPullRefreshNormal:
			//NSLog(@"wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww EGOOPullRefreshNormal =[%@]",@"up");
		...
		case EGOOPullRefreshLoading:
			//NSLog(@"wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww EGOOPullRefreshLoading =[%@]",@"up");
