...
- (void)setAxisLocationX:(WSAxisLocation *)axisLocation {
    ...
    [_axisLocationX release];
    _axisLocationX = [axisLocation retain];
}

- (void)setAxisLocationY:(WSAxisLocation *)axisLocation {
    [axisLocation setCoordDelegate:self];
    [_axisLocationY setCoordDelegate:nil];
    [_axisLocationY release];
    _axisLocationY = [axisLocation retain];
}
...
- (void)dealloc {
    ...
    [_view setAxisDelegate:nil];
    [_view setPlotController:nil];
    [_view setCoordDelegate:nil];
    [_view setDataDelegate:nil];
    [_axisLocationX setCoordDelegate:nil];
    [_axisLocationY setCoordDelegate:nil];
    [_view release];
    [_coordX release];
    ...
    [_pinchGestureRecognizer setDelegate:nil];
...
#ifdef __IPHONE_4_0
    Block_release(_alertBlock);
    [_standardProperties release];
    [_alertedProperties release];
    _standardProperties = nil;
    _alertedProperties = nil;
    _alertBlock = nil;
#endif ///__IPHONE_4_0
