...
- (void)viewDidLoad
{
    ...
    self.badgeSuperView = [[UIImageView alloc] initWithFrame:CGRectIntegral(CGRectMake(infoBut.frame.origin.x+65,
                                                                                       ...
                                                                                       16,
                                                                                       16))];
    self.badgeView = [[JSBadgeView alloc] initWithParentView:_badgeSuperView
                                                   alignment:JSBadgeViewAlignmentBottomLeft];
    //无意义，主要为了把badgeView撑起来
...
/* 去掉港口电厂查询条件 modified by mawp 2013.03.29
...
/* 去掉港口电厂筛选条件 modified by mawp 2013.02.26
...
- (void)reStoreMapRegion{
    ...
    //高德地图调整 modified by mawp 2013.03.26
    theCoordinate.latitude=29.6955667121; //纬度
    theCoordinate.longitude=122.0461133192; //经度
